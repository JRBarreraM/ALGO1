"""	Lab02ejercicio6.py
	...
	devuelve m/n si m=10, m*n si m=5, m+n si m=3, m**n si m=2 y en cualquier otro devuelve m.
	...
	o: int // SALIDA: Resultado de la operacion correspondiente a cada caso.
"""
