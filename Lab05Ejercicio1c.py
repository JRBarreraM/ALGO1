"""	Lab05Ejercicio1.py​ (Version por Contrato)
	DESCRIPCION: Programa que dado una secuencia de números enteros, \
	verifica si estan ordenados de forma estrictamente creciente. \
...
while i<100 and c>=0:
	...
	if i==0 and c==0:
		print("No se admite la secuencia vacia")
		sys.exit()

	elif i==1 and c==0:
		print("No se admite la secuencia unitaria")
		sys.exit()
